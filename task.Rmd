...
data$train_hours=scale(data$train_hours) # 数据归一化，为了和测试发展指数量纲统一
...
data_train$train_hours=scale(data_train$train_hours) # 数据归一化，为了和测试发展指数量纲统一
...
# 公司类型
barplot(table(data$company_type),xlab="company type",main=NULL)
