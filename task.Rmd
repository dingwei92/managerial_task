...
data$train_hours_scale=scale(log(data$train_hours)) # 先对数据进行对数计算，然后再进行标准化，为了和城市发展指数统一量纲
...
data_train$train_hours_scale=scale(log(data_train$train_hours)) # 数据归一化，为了和测试发展指数量纲统一
